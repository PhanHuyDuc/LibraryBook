...
{
    public class NewContentViewComponent : ViewComponent
    {
        private readonly IContentService _contentService;
        private readonly IContentCategoryService _contentCategoryService;
        public NewContentViewComponent(IContentService contentService, IContentCategoryService contentCategoryService)
        {
