...
namespace LibraryBook.Infrastructure.Migrations
{
    ...
    [Migration("20240713171353_AddMenuToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryBook.Domain.Entities.SubMenu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryBook.Domain.Entities.SubSubMenu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SubSubMenuLink")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LibraryBook.Domain.Entities.MenuCategory", b =>
                {
                    b.HasOne("LibraryBook.Domain.Entities.MainMenu", null)
                        .WithMany("MainMenuCategory")
                        .HasForeignKey("MainMenuId");
                });

            modelBuilder.Entity("LibraryBook.Domain.Entities.SubMenu", b =>
                {
                    b.HasOne("LibraryBook.Domain.Entities.MainMenu", "MainMenu")
                        .WithMany()
                        .HasForeignKey("MainMenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LibraryBook.Domain.Entities.SubSubMenu", b =>
                {
                    b.HasOne("LibraryBook.Domain.Entities.SubMenu", "SubMenu")
                        .WithMany()
